    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            synchronized (TAG) {
                ...
                sharedPreferences.edit().putBoolean(LoginActivity.SENT_TOKEN_TO_SERVER, true).apply();
            }
        } catch (Exception e) {
            ...
            sharedPreferences.edit().putBoolean(LoginActivity.SENT_TOKEN_TO_SERVER, false).apply();
        }
    }
